  ...
  <body>
        <div class="container" style="background: #222; border-radius: 12px; padding: 15px;">
            <div class="col-md-12">
                ...
                <div class="row" style="background: #1abc9c; padding: 15px;">
                    ...
                    <div class="col-md-6" style="color: #fff;">
                        <p>Chào bạn <strong style="color: #000; text-decoration: underline;">{{$name}}</strong>, chúng tôi đã xác bạn đã đặt hàng ở cửa hàng chúng tôi gồm những thông tin như sau:</p>
                    </div>
                    ...
                    <p style="color: #fff; text-align: center;">Xem lại lịch sử đơn hàng tại : 
                        <a href="{{url('/lich-su-mua-hang')}}" target="_blank">
