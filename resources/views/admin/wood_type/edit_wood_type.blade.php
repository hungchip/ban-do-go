        ...
        <div class="col-xs-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @foreach($edit_wood_type as $edit_value)
                    <form action="{{URL::to('/update-wood-type/'.$edit_value->wood_id)}}" method="POST" role="form"
                        ...
                        <div class="col-lg-12 form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="name" value="{{$edit_value->wood_name}}" class="form-control"
                                        required="" name="wood_name">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{$edit_value->wood_slug}}" id="slug" readonly="true" class="form-control" name="wood_slug">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <textarea rows="8" required="" class="form-control"
                                        name="wood_desc">{{$edit_value->wood_desc}}</textarea>
                                </div>
                            </div>
                        </div>
